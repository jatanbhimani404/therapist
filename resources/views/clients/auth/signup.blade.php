...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('chat-assets/assets/vendor/css/pages/sign-up.css') }}" />
</head>
        ...
        <div class="row h-100">
            ...
            <div class="col-12 col-md-6 d-flex align-items-center justify-content-center">
                <div class="card shadow-lg p-5 rounded my-3">
                    ...
                    <p class="text-center text-muted small mb-4">Search & book sessions with licensed professionals,
                        confidentially & securely.</p>
                    ...
                    <form>
                        ...
                        <div class="row mb-3 g-3">
                            ...
                            <div class="col position-relative">
                                ...
                                <input type="password" id="confirmation" class="form-control pe-5"
                        ...
                        <div class="mb-3">
                            <div class="form-check">
                                ...
                                <label class="form-check-label small" for="remember">By signing up, you agree to our <a href="#" class="fw-bolder">Terms of Service</a> & <a href="#" class="fw-bolder">Privacy Policy</a>.</label>
                            </div>
                        </div>
                        <button type="submit"
                            class="btn btn-primary w-100 py-2 fw-semibold text-black mb-3 login-submit-btn">SIGN UP
                            →</button>
