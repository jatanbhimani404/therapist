        ...
        <div class="card shadow-lg p-5 rounded my-3">
          ...
          <form>
            ...
            <div class="mb-3 position-relative">
              ...
              <i class="position-absolute top-50 end-0 translate-middle-y me-3 bi bi-eye-fill" style="cursor: pointer;"></i>
            </div>
            ...
            <button type="submit" class="btn btn-primary w-100 py-2 fw-semibold text-black mb-3 login-submit-btn">LOG IN →</button>
            ...
            <div class="d-flex gap-2">
              <button class="btn flex-fill btn-outline-secondary signin-btn">
                <img src="{{asset('chat-assets/assets/img/icons/brands/google-icon.png')}}" alt="" style="width: 15px;"><small class="d-lg-block d-none">&nbsp;Google</small>
              </button>
              <button class="btn flex-fill btn-outline-secondary signin-btn">
                <img src="{{asset('chat-assets/assets/img/icons/brands/facebook-icon.png')}}" alt="" style="width: 15px;"><small class="d-lg-block d-none">&nbsp;Facebook</small>
              </button>
              <button class="btn flex-fill btn-outline-secondary signin-btn">
                <img src="{{asset('chat-assets/assets/img/icons/brands/apple-icon.png')}}" alt="" style="width: 15px;"><small class="d-lg-block d-none">&nbsp;Apple</small>
              </button>
            </div>
          </form>
